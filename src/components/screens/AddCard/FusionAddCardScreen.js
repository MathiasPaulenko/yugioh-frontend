...
export const FusionAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(fusionBodyRequest);
    ...
    return (
        <>
            ...
            <RelatedCards cardType="monster" cardSubtype='Fusion Monster' title='Card of the same type in the collection' />

        </>
    )
}

export const fusionBodyRequest = {
    card_number: "",
    serial_code: "",
    name: "",
    description: "",
