...
export const LinkAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(linkBodyRequest);
    ...
    return (
        <>
            ...
            <RelatedCards cardType="monster" cardSubtype='Link Monster' title='Card of the same type in the collection' />
