...
export const PendulumAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(pendulumBodyRequest);
        ...
        <>
            ...
            <div className='row mt-3 align-items-center mb-3'>
                <div className='col-sm-8'>
                    <Title value='Add New Pendulum Monster Card' />
                </div>
            ...
            <form className="animate__animated animate__fadeIn" onSubmit={handleAddCard}>
                <div className="row ">
                    ...
                    <InputField req={true} type="number" info="Scale" autoComplete="on" />
            ...
            <RelatedCards cardType="monster" cardSubtype='Pendulum Effect Monster' title='Card of the same type in the collection ' />

        </>
    )
}

export const pendulumBodyRequest = {
    card_number: "",
    serial_code: "",
    name: "",
    description: "",
