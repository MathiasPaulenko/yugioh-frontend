...
export const RitualAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(ritualBodyRequest);
        ...
        <>
            ...
            <div className='row mt-3 align-items-center mb-3'>
                <div className='col-sm-8'>
                    <Title value='Add New Ritual Monster Card' />
                </div>
            ...
            <RelatedCards cardType="monster" cardSubtype='Ritual Effect Monster' title='Card of the same type in the collection' />

        </>
    )
}

export const ritualBodyRequest = {
    card_number: "",
    serial_code: "",
    name: "",
    description: "",
