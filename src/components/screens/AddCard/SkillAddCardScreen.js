...
export const SkillAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(skillBodyRequest);
        ...
        <>
            <div className='row mt-3 align-items-center mb-3'>
                <div className='col-sm-8'>
                    <Title value='Add New Skill Card' />
                </div>
            ...
            <form className="animate__animated animate__fadeIn" onSubmit={handleAddCard}>
                <div className="row ">
                    ...
                    <InputField req={true} type="text" info="Race" />
            ...
            <RelatedCards cardType="Skill" cardSubtype='Skill Card' title='Card of the same type in the collection' />

        </>
    )
}

export const skillBodyRequest = {
    serial_code: "",
    card_number: "",
    name: "",
    description: "",
