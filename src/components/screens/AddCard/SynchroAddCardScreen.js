...
export const SynchroAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(synchroBodyRequest);
        ...
        <>
            ...
            <div className='row mt-3 align-items-center mb-3'>
                <div className='col-sm-8'>
                    <Title value='Add New Synchro Monster Card' />
                </div>
            ...
            <RelatedCards cardType="monster" cardSubtype='Synchro Monster' title='Card of the same type in the collection' />

        </>
    )
}

export const synchroBodyRequest = {
    card_number: "",
    serial_code: "",
    name: "",
    description: "",
