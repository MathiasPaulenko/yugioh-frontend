...
export const TokenAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(tokenBodyRequest);
        ...
        <>
            <div className='row mt-3 align-items-center mb-3'>
                <div className='col-sm-8'>
                    <Title value='Add New Token Card' />
                </div>
            ...
            <RelatedCards cardType="token" cardSubtype='Token Card' title='Card of the same type in the collection' />

        </>
    )
}

export const tokenBodyRequest = {
    card_number: "",
    serial_code: "",
    name: "",
    description: "",
