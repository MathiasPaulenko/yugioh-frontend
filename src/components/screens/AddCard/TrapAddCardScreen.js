...
export const TrapAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(trapBodyRequest);
    ...
    return (
        <>
            ...
            <RelatedCards cardType="trap" cardSubtype='Trap Card' title='Other cards of the same type' />

        </>
    )
}

export const trapBodyRequest = {
    serial_code: "",
    card_number: "",
    name: "",
    description: "",
