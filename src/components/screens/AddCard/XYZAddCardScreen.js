...
export const XYZAddCardScreen = () => {
    const navigate = useNavigate();
    const [bodyRequest, setBodyRequest] = useState(xyzBodyRequest);
        ...
        <>
            ...
            <div className='row mt-3 align-items-center mb-3'>
                <div className='col-sm-8'>
                    <Title value='Add New XYZ Monster Card' />
                </div>
            ...
            <form className="animate__animated animate__fadeIn" onSubmit={handleAddCard}>
                <div className="row ">
                    ...
                    <InputField req={true} type="number" info="Level" placeholder="Range" autoComplete="on" />
            ...
            <RelatedCards cardType="monster" cardSubtype='XYZ Monster' title='Other cards of the same type' />
